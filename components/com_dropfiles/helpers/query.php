...
/**
 * Dropfiles Component Query Helper
 *
 * @static
 * @package		Joomla.Site
 * @subpackage	com_content
...
class DropfilesHelperQuery
{
	...
	public static function getQueryDate($orderDate) {
		...
		{
			case 'modified' :
				$queryDate = ' CASE WHEN a.modified = 0 THEN a.created_time ELSE a.modified END';
				break;

			// use created if publish_up is not set
			case 'published' :
				$queryDate = ' CASE WHEN a.publish_up = 0 THEN a.created_time ELSE a.publish_up END ';
				break;

			case 'created' :
			default :
				$queryDate = ' a.created_time ';
				break;
		}
