 ...
 * @version		1.6
 */
class UuControllerReset extends UuController
{
	/**
	...
	public function request()
	{
		...
		$model	= $this->getModel('Reset', 'UuModel');
		...
		if ($return instanceof Exception) {
			...
			$itemid = UuHelperRoute::getResetRoute();
			$itemid = $itemid !== null ? '&Itemid='.$itemid : '';
			$route	= 'index.php?option=com_uu&view=reset'.$itemid;
			...
			$itemid = UuHelperRoute::getResetRoute();
			$itemid = $itemid !== null ? '&Itemid='.$itemid : '';
			$route	= 'index.php?option=com_uu&view=reset&layout=confirm'.$itemid;
	...
	function confirm()
	{
		...
		if ($return instanceof Exception)
		{
			...
			$itemid = UuHelperRoute::getResetRoute();
			$itemid = $itemid !== null ? '&Itemid='.$itemid : '';
			$route	= 'index.php?option=com_uu&view=reset&layout=complete'.$itemid;
	...
	public function complete()
	{
		...
		$app	= JFactory::getApplication();
		$model	= $this->getModel('Reset', 'UuModel');		$data	= JRequest::getVar('jform', array(), 'post', 'array');
