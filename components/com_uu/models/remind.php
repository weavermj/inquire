 ...
 * @version		1.5
 */
class UuModelRemind extends JModelForm
{
	/**
	...
	{
		// Get the form.
		$form = $this->loadForm('com_uu.remind', 'remind', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
	...
	public function processRemindRequest($data)
	{
		...
		$link	= 'index.php?option=com_uu&view=login'.$itemid;
