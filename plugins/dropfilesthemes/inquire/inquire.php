 ...
 * @subpackage Plugin
 */
class plgDropfilesthemesInquire extends dropfilesPluginBase
{
    public $name = 'inquire';
    ...
    public function onShowFrontCategory($options){
        ...
        $doc->addScript(JURI::base('true').'/plugins/dropfilesthemes/inquire/js/handlebars-1.0.0-rc.3.js');
        $doc->addScript(JURI::base('true').'/plugins/dropfilesthemes/inquire/js/script.js');
        ...
        if(!empty($this->options['files']) || dropfilesBase::loadValue($this->params,'inquire_showsubcategories',1)==1){
            ...
            $style  = '.file {margin : '.dropfilesBase::loadValue($this->params,'inquire_margintop',5).'px '.dropfilesBase::loadValue($this->params,'inquire_marginright',5).'px '.dropfilesBase::loadValue($this->params,'inquire_marginbottom',5).'px '.dropfilesBase::loadValue($this->params,'marginleft',5).'px;}';
