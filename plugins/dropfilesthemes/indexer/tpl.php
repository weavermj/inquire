        ...
        <?php foreach ($this->files as $file): ?>
            <div class="file">
                ...
                <div class="filecontent">
                    ...
                    <a class="downloadlink" href="index.php?option=com_dropfiles&task=frontfile.download&id=<?php echo $file->id ; ?>"><?php echo JText::_('COM_DROPFILES_DEFAULT_FRONT_DOWNLOAD'); ?></a>
                    <?php endif; ?>
                    <?php if(dropfilesBase::loadValue($this->params,'showtitle',1)==1): ?>
                    <h3><a href="index.php?option=com_dropfiles&task=frontfile.download&id=<?php echo $file->id ; ?>"><?php echo $file->title ; ?></a></h3>
                    <?php endif; ?>
