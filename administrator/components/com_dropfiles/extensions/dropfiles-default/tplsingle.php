...
<div class="dropfiles-content dropfiles-file dropfiles-content-default">
                <div class="file">
                    ...
                    <div class="filecontent">
                        ...
                        <a class="openlink <?php echo (dropfilesBase::loadValue($this->params,'usegoogleviewer',1)==1)?'dropfileslightbox':'';?>" <?php echo (dropfilesBase::loadValue($this->params,'usegoogleviewer',1)==2)?'target="_blank"':'';?> href="<?php echo $this->file->viewerlink; ?>"><?php echo JText::_('COM_DROPFILES_DEFAULT_FRONT_OPEN'); ?></a>
                        <?php endif; ?>
                        </div>
                        <?php endif; ?>
