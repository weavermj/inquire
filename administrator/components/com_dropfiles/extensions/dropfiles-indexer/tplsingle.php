...
<div class="dropfiles-content dropfiles-file dropfiles-content-default">
                <div class="file">
                    ...
                    <div class="filecontent">
                        ...
                        <a class="downloadlink" href="index.php?option=com_dropfiles&task=frontfile.download&id=<?php echo $this->file->id ; ?>"><?php echo JText::_('COM_DROPFILES_DEFAULT_FRONT_DOWNLOAD'); ?></a>
                        <?php endif; ?>
                        <?php if(dropfilesBase::loadValue($this->params,'showtitle',1)==1): ?>
                        <h3><a href="index.php?option=com_dropfiles&task=frontfile.download&id=<?php echo $this->file->id ; ?>"><?php echo $this->file->title ; ?></a></h3>
                        <?php endif; ?>
                        <div><?php echo $this->file->description ; ?></div>
    <!--                    <?php if(dropfilesBase::loadValue($this->params,'showversion',1)==1 || (dropfilesBase::loadValue($this->params,'showsize',1)==1 && trim($this->file->version!=''))): ?>
                        <div>-->
                            <?php if(dropfilesBase::loadValue($this->params,'showversion',1)==1 && trim($this->file->version!='')): ?>
